...
//     if (x == but.x && y == but.y) {
//         var img = document.getElementById("salad");
//         StatutBouton = document.getElementById("suivant").disabled;
//         turtle.ct.drawImage(img, but.x * 100, but.y * 100, 100, 100);
//         setTimeout(() => {
//             alert("victoire");
//         }, 200);
